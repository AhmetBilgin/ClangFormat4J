...
public class XMLReplacementHandler extends DefaultHandler2 {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (charactersBuilder != null) {
            ...
            edits.add(new ReplaceEdit(currentOffset, currentLength, replacedText));
    ...
    public void startElement(String uri, String localName, String qname, Attributes attributes) throws SAXException {
        ...
        if (qname.equals(REPLACEMENT_TAG_NAME)) {
            ...
            {
                String offsetAttributeString = attributes.getValue(OFFSET_ATTRIBUTE_NAME);
            ...
            }
            {
                ...
                if (lengthAttributeString != null) {
                    ...
                    throw new SAXException(
                            "Missing " + LENGTH_ATTRIBUTE_NAME + " attribute in " + REPLACEMENT_TAG_NAME + " element");
                }
            }
        }
    }
