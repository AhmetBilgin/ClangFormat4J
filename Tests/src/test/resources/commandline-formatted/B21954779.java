...
class B21954779 {
    {
        ...
        fail(String.format("       Experiment name %s is used multiple times in %s", expName, envName, zzzzzzzzzzzz,
                zzzzzzzzzzzz));
        ...
        getContext().getErrorReporter().log(
                new RuntimeException("Called layout with a non-zero segment index: " + segmentIndex));
