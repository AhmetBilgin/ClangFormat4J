...
class B20128760 {
    void f() {
        ...
        XXxxxx<Xxxx, XxxxxxxXxxxxxxxxxxXxxxxxxxx> xxxxxxxxxXxxXxxXxXxxxxxxxXx =
                XX.xxxxXxxXxxx2("XxxxXxxxxxxxXxxxXxxxXxxxxxxxXxxxXxxXxxxxxxXxxxxxxxx", xxxxxxxxXxxxXxXxxxxxxxXx,
                          xxxxxxxxXxxxXxxxxXxxxXxXxxxxxxxXx)
                        .xxxxxxxxXx("XxxxxxxxXxxxxxxxxXxx", xxxxxxxxXxxxxxxxxXxxXx,
                                XX.xxxxxXx(XX.xxxxx(), XX.xxxxxx(XxxxxxxXxxxxxxxxxxXxxxxxxxx.xxxxx)));

        xxXxxxxxxxXxxxXxxx = (XxxxXxxx)xxxxxxxxXxxxxxxxxx.xxx()
                                     .xxxxxXxxxxxx.xxxXxxxxxxx(xxxxxxxxXxxxxxxxxx.xxx().xxxxXxxxx.xxxXxxxxxxXxxx() - 1)
                                     .xxxXxxx()
                                     .xxxxXxxxXxXx(X.xx.xxxxxxxxxxxxxxxxxxxxxxxxxxx);

        xxxxxxXxxx(xxxxxxxxxx.xxxXxxxXxxxxXxxxxxxxxxxXxxxXxxxXxxxxXxxx(XXXxXXXXxXX, XXXXXXxXXXxXXXXxXX, XXXXXxXX)
                           .xxxxxxxxxxxXxxxXxxxXxxxxx())
                .xxxxxxxxXxxxxxx(xxxxXxxxxxxxxxxXxxxXxxxXxxxx(xxxx1Xxxx, Xxxxx.XXxXXX),
        ...
        assertThat(main.format("--offset", "0", "--length", String.valueOf(input.length()), path.toString()))
                .isEqualTo(0);
    }

    private static class GenerateDashboardRowFn
            extends XX.XxXx<Xxxx<Xxxx, Xxxxx2.XxxXxxxXxxxxxxxxxx<XxxxxxxxXxxx, Xxxx<XxxxxxxxXxxx, XxxxxxxXxxxxxxxx>>>,
                    Xxxx<Xxxx, XxxxxxxXxxxxxxxxxxXxxxxxxxx>> {}

    public class XxxxxxxXxxxxxxxXxxxXxxxxXxxxxxx<X>
            extends XxxxxxxXxxxxxxxXxxxXxxxxXxxxxxx<XxxxxxxXxxxxxxxXxxxXxxxxXxxxxxx<X>,
                    XxxxXxxxxxxXxxxxxxxx<? extends Xxxxxxxx<X>>> {}
    ...
    public class Foo extends Xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
            implements Xxxxxxxxxxxxx<Xxxxxxxxxxxxxxxxxxxxxxxxxxxxx, Xxxxxxxxxxxxxxxxxxxxxxxxxxxxx,
                                 ...
                                 -> m.getFieldValues()
                                            ...
                                            .flatMap(fv
                                                    -> FieldDTO.deserializeStringToListOfStrings(fv.getValue())
                                                               .stream()
                                                               .map(id
                                                                       -> new ItemKey(fieldsById.get(fv.getKey())
                                                                                              .getItemTypeId(),
                                                                               id))));
}
}
