...
class B20701054 {
    void m() {
        ...
        PTable<Long, Long> adImpressionsByAccount = impressionExtractor.getImpressionBreakdownByAccountId().parallelDo(
                "rekeyAdImpressionsByAccountId", new ExtractTotalImpressionsFn());

        PTable<String, CrawlError> crawlerErrorsByCode =
                crawlReportSource.read("readCrawlReportTable")
        ...
        (test ? xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx :
        ...
        edu.oswego.cs.dl.util.concurrent.misc.ImmutableList
